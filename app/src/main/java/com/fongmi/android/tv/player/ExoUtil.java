...
public class ExoUtil {
    ...
    public static RenderersFactory buildRenderersFactory() {
        return new DynamicVolumeRenderersFactory(App.get()).setExtensionRendererMode(Players.isSoft(Players.EXO) ? DefaultRenderersFactory.EXTENSION_RENDERER_MODE_PREFER : DefaultRenderersFactory.EXTENSION_RENDERER_MODE_ON);
    }
